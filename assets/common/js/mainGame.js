...
function click(e) {
    ...
    if (redes == 1) {
        guardaRedes.src = '../assets/common/sprites/Sprite1.png';
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite2.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite3.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite4.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite5.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite6.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite7.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite8.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
        ...
        guardaRedes.src = '../assets/common/sprites/Sprite9.png';
        guardaRedes.addEventListener('load', function () { window.setInterval(animateguardaRedes, 1000); });
